        ...
        <div class="card chart-grd same-card">
          <div class="card-body depostit-card p-0">
            <div class="depostit-card-media d-flex justify-content-between pb-0">
              ...
              <div class="icon-box bg-primary-light" v-html="SVGImage.indexDolarIcon"></div>
            </div>
            <div id="apaxlinechart">
              <apexchart
                height="40"
        ...
        <div class="card chart-grd same-card">
          <div class="card-body depostit-card p-0">
            <div class="depostit-card-media d-flex justify-content-between pb-0">
              ...
              <div class="icon-box bg-danger-light" v-html="SVGImage.indexDolarIcon2"></div>
            </div>
      ...
      <div class="col-xl-8">
        <div class="card overflow-hidden">
          ...
          <div class="card-body p-0">
            <div id="overiewChart" ref="updateData">
              <apexchart
                type="line"
                height="300px"
...
import TodoItem from './home/TodoItem.vue'

export default defineComponent({
  name: 'cardChart',
  components: { apexchart: VueApexCharts, TodoItem },
  ...
  methods: {
    updateData(value: string) {
      switch (value) {
        case 'week':
          this.state.series[0].data = [75, 85, 72, 100, 50, 100, 80, 75, 95, 35, 75, 100]
          this.state.series[1].data = [44, 65, 55, 75, 45, 55, 40, 60, 75, 45, 50, 42]
          this.state.series[2].data = [30, 25, 45, 30, 25, 35, 20, 45, 35, 20, 35, 20]
          break
        case 'month':
          this.state.series[0].data = [20, 50, 80, 52, 10, 80, 50, 30, 95, 10, 60, 85]
          this.state.series[1].data = [40, 25, 85, 45, 85, 25, 95, 65, 45, 45, 20, 12]
          this.state.series[2].data = [65, 45, 25, 65, 45, 25, 75, 35, 65, 75, 15, 65]
          break
        case 'year':
          this.state.series[0].data = [30, 20, 80, 52, 10, 90, 50, 30, 95, 20, 60, 85]
          this.state.series[1].data = [40, 25, 40, 45, 85, 25, 50, 65, 45, 60, 20, 12]
          this.state.series[2].data = [65, 45, 30, 65, 45, 25, 75, 40, 65, 50, 15, 65]
          break
        case 'all':
          this.state.series[0].data = [20, 50, 80, 60, 10, 80, 50, 40, 95, 20, 60, 85]
          this.state.series[1].data = [40, 25, 30, 45, 85, 25, 95, 65, 50, 45, 20, 12]
          this.state.series[2].data = [65, 45, 25, 65, 45, 25, 30, 35, 65, 75, 15, 65]
          break
