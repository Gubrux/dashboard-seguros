  ...
  routes: [
    {
      ...
      name: "index",
      component: () =>
        import("../views/pages/dashboard/produccion/Dashboard.vue"),
      meta: { layout: "layout" },
    },
    // {
    //   path: "/index-2",
    ...
    {
      path: "/",
      name: "dashboard_produccion",
      component: () =>
        import("../views/pages/dashboard/produccion/DashboardProduccion.vue"),
      meta: { layout: "layout" },
    },
    {
      path: "/dashboard-comparativos",
      name: "dashboard_comparativos",
      component: () =>
        import(
          "../views/pages/dashboard/comparativos/DashboardComparativo.vue"
        ),
      meta: { layout: "layout" },
    },
    {
      path: "/dashboard-siniestros",
      name: "dashboard_siniestros",
      component: () =>
    ...
    },
    {
      ...
      component: () =>
        import("../views/app/customerManeger/CustomerProfile.vue"),
      meta: { layout3: "layout3" },
    },
    {
      path: "/contacts",
