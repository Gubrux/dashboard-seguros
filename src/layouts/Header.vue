          ...
          <ul class="navbar-nav header-right">
                ...
                >
                  <ul class="timeline">
                    <li>
                      ...
                      <RouterLink class="timeline-panel text-muted" to="?">
                        <span>10 minutes ago</span>
                        <h6 class="mb-0">
                          Youtube, RouterLink video-sharing website, goes live
                    ...
                    <li>
                      ...
                      <RouterLink class="timeline-panel text-muted" to="?">
                        ...
                        <p class="mb-0">
                          Quisque RouterLink consequat ante Sit amet magna at
                          volutapt...
                        </p>
                      </RouterLink>
                    </li>
                    ...
                    <li>
                      ...
                      <RouterLink class="timeline-panel text-muted" to="?">
                        <span>20 minutes ago</span>
                        <h6 class="mb-0">
                          Mashable, RouterLink news website and blog, goes live.
                        </h6>
                      </RouterLink>
                    </li>
                    <li>
            ...
            <!-- <li class="nav-item dropdown notification_dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <RouterLink class="all-notification" to="?"
            ...
            <!-- <li class="nav-item dropdown notification_dropdown">
              <a
                ...
                v-html="headerChatSvg"
                @click="chatboxHandler"
              >
              </a>
            </li> -->
            <li class="nav-item dropdown notification_dropdown">
              <RouterLink
                :class="`nav-link bell dz-fullscreen ${size ? 'active' : ''}`"
                to="?"
                v-html="headerZoomSvg"
                @click="fullScreen"
              >
              </RouterLink>
            </li>
                ...
                >
                  <div class="header-info2 d-flex align-items-center">
                    <div class="header-media">
                      <img src="../assets/icons/segu_logo.jpg" alt="" />
                    </div>
                    <div class="header-info">
                      <h6>Seguridad Seguros</h6>
                      <p>info@zgroup.com</p>
                    </div>
                  </div>
                </RouterLink> -->
                  ...
                  <div class="card border-0 mb-0">
                    ...
                    <div class="card-body px-0 py-2">
                      ...
                      >
                        ...
                        ><span
                          class="badge badge-sm badge-secondary light rounded-circle text-white ms-2"
                          >4</span
                        >
                      </RouterLink>
                      <RouterLink to="?" class="dropdown-item ai-icon">
                        <svg
                          width="20"
                          height="20"
                          viewBox="0 0 24 24"
...
export default defineComponent({
  ...
  setup() {
    ...
    return { openChatbox, size, toggleDarkMode, isDarkMode };
  },
  methods: {
    chatboxHandler() {
...
.slider:before {
  ...
  left: 4px;
  bottom: 4px;
  background-color: rgb(234, 218, 126);
  transition: 0.4s;
  border-radius: 50%;
}
